...
#define INNER_DELTA_CHAIN_LENGTH_THRESHOLD ((int)2)
#define LEAF_DELTA_CHAIN_LENGTH_THRESHOLD ((int)8)
...
static constexpr int INNER_NODE_SIZE_UPPER_THRESHOLD = 8;
static constexpr int INNER_NODE_SIZE_LOWER_THRESHOLD = 2;
static constexpr int LEAF_NODE_SIZE_UPPER_THRESHOLD = 8;
static constexpr int LEAF_NODE_SIZE_LOWER_THRESHOLD = 2;
