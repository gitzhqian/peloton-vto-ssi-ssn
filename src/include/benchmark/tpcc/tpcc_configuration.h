...
static const oid_t nation_table_oid = 3010;
static const oid_t nation_table_pkey_index_oid = 30010;
static const oid_t region_table_oid = 3011;
static const oid_t region_table_pkey_index_oid = 30011;
static const oid_t supplier_table_oid = 3012;
static const oid_t supplier_table_pkey_index_oid = 30012;

static bool enable_papi = true;

//static std::vector<std::vector<std::pair<type::Value, type::Value>>> supp_stock_map(10000);
