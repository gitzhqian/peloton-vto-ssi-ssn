...
//if someone is reading the tuple
//   if the reader start before the current transaction, then return false
//   if the reader start after the current transaction, update transaction id,
//        and return true
bool TimestampOrderingTransactionManager::AcquireOwnership(
  ...
  //if someone has perform read before me, may be flying or commited
  //then current txn can not write
