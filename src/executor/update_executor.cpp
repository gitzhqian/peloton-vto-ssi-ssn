...
bool UpdateExecutor::DExecute() {
  ...
  if(concurrency_protocol == ConcurrencyType::CONCURRENCY_TYPE_SSI ||
    ...
    for (oid_t visible_tuple_id : *source_tile) {
      ...
      if (transaction_manager.IsOwner(current_txn, tile_group_header, physical_tuple_id) == true) {
      ...
      } else if (transaction_manager.IsOwnable(current_txn, tile_group_header,
                                               physical_tuple_id)) {
