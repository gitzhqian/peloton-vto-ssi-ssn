...
bool RunStockLevel(const size_t &thread_id) {
  /*
     ...
     "getStockCount": "SELECT COUNT(DISTINCT(OL_I_ID)) FROM ORDER_LINE, STOCK  WHERE OL_W_ID = ? AND OL_D_ID = ?
...
//  district_key_values.push_back(type::ValueFactory::GetIntegerValue(w_id).Copy());
  district_key_values.push_back(type::ValueFactory::GetVarcharValue(std::to_string(w_id)));
  district_expr_types.push_back(ExpressionType::COMPARE_EQUAL);
//  district_key_values.push_back(type::ValueFactory::GetIntegerValue(d_id).Copy());
  district_key_values.push_back(type::ValueFactory::GetVarcharValue(std::to_string(d_id)));
  ...
  LOG_TRACE("getStockCount: SELECT COUNT(DISTINCT(OL_I_ID)) FROM ORDER_LINE, STOCK  WHERE OL_W_ID = ? AND OL_D_ID = ? "
      "AND OL_O_ID < ? AND OL_O_ID >= ? AND S_W_ID = ? AND S_I_ID = OL_I_ID AND S_QUANTITY < ?");
...
//    order_line_key_values.push_back(type::ValueFactory::GetIntegerValue(curr_o_id).Copy());
    order_line_key_values.push_back(type::ValueFactory::GetVarcharValue(std::to_string(w_id)));
    order_line_key_values.push_back(type::ValueFactory::GetVarcharValue(std::to_string(d_id)));
    order_line_key_values.push_back(type::ValueFactory::GetVarcharValue(std::to_string(curr_o_id)));
...
//    stock_key_values.push_back(type::ValueFactory::GetIntegerValue(w_id).Copy());
    stock_key_values.push_back(type::ValueFactory::GetVarcharValue(std::to_string(w_id)));
